...
females<-read.csv('/scratch4/blangme2/jessica/dandd/scratch/pangenome/female_progu30_56_dashing.csv') %>% 
  mutate(delta_pos=delta, ngenomes=ngen) %>% mutate(dataset="Pangenome")
...
overlap<-read.csv('/scratch4/blangme2/jessica/dandd/scratch/pangenome/overlap_progu90_8_dashing.csv') %>% 
  mutate(delta_pos=delta, ngenomes=ngen, dataset="Pangenome")
...
hgsvc2<-read.csv('/scratch16/blangme2/jessica/dandd/scratch/HGSVC2/hgsvc2_overlap_progu.csv') %>% 
  mutate(delta_pos=delta, ngenomes=ngen, dataset="HGSVC2") 


plotCumulativeUnion(progu=rbind(overlap,hgsvc2),title="8 Overlapping Female Samples", nshow=0)
